...
st.title(':zap: Montey Hall Simulation')
st.image("https://static.scientificamerican.com/dam/m/7268d6df988be0a/original/saw0924Pars_lead.jpg?m=1720544368.494", width=500)

num_games = st.number_input('Enter number of games to simulate', min_value=1, max_value=100000, value=100)
